  ...
  if (!content.about) {
    content.about = {
      ...
      aboutUs: {
        ...
        content: [
          "Founded in 1999, Police Modern School is a premier Institution with attractive building and modern techniques to expose it as an ideal English medium school of Mirzapur.",
          "The school cultivates the sacred feelings of secularism, national integration, fraternity and makes extra effort to protect our rich Indian Culture and Tradition."
        ]
      },
      philosophy: {
