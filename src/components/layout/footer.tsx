      ...
      <div className="container mx-auto px-4 md:px-6 py-4 relative z-10">
       ...
       <div className="container mx-auto px-4 md:px-6 py-4 relative z-10">
           <div className="flex justify-center items-center">
                <Link href={whatsappLink} target="_blank" rel="noopener noreferrer" aria-label="Contact Developer on WhatsApp" className="footer-link flex items-center gap-2 notranslate">
                    <WhatsAppIcon />
